    ...
    def __init__(self):
        ...
        company_prompt = PromptTemplate(
            ...
            template="what are the {product} in the {country} industry? List at least 20 companies and provide a description for each company, with the description being within 20 words."
                     "return the results as a JSON array with the keys `company_name` and `description`, company_name return English and Chinese, English name in the bracket, description return only Chinese.on other word, only json. return only english."
